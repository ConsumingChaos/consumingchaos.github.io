...
def link_action_configs(
    ...
    return [
        action_config(
            ...
            tools = [tool(path = "{}/bin/ld64.lld".format(binutils))],
            flag_sets = [
