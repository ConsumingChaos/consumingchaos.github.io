...
load("//bazel/toolchain_rules/cc_tools:lld-link.bzl", lld_link_link_action_configs = "link_action_configs")
load("//bazel/toolchain_rules/cc_tools:llvm-ar.bzl", llvm_ar_archive_action_configs = "archive_action_configs")
load("//bazel/toolchain_rules/cc_tools:llvm-strip.bzl", llvm_strip_strip_action_configs = "strip_action_configs")
load("//bazel/toolchain_rules/cc_tools:wasm-ld.bzl", wasm_ld_link_action_configs = "link_action_configs")
...
llvm_cc_toolchain_config = rule(
    ...
    attrs = {
        ...
        "binutils": attr.string(mandatory = True),
