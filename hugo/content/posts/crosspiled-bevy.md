...
# [Example Code](https://github.com/ConsumingChaos/consumingchaos.github.io/tree/master/examples/crosspiled-bevy)\*\*

# Motivation

Building on [Nix + Bazel Crosspiling]({{< ref "/posts/nix-bazel-crosspiling.md" >}}), my next step is to build something of substance to make sure the crosspiling toolchains actually work. As I'm planning to play around with [Bevy](https://bevyengine.org/) and it's a non-trivial project, it seemed like the perfect fit. My test case is making sure the following Bevy Hello World can build successfully:
